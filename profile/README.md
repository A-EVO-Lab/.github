...
📄 **Evo-Harness** — *Context-to-Harness Skill Compilation* [arXiv 2608.15071](https://arxiv.org/abs/2608.15071).
...
## 📢 News
- **8/15** **New EMNLP 2026 Paper**, [*Evo-Harness: Context-to-Harness Skill Compilation for Self-Evolving Agents
*](https://arxiv.org/abs/2608.15071) (arXiv 2608.15071) Agents in realistic environments face a stream of novel tasks with only a one-shot chance to improve, and each execution leaves behind a rich but noisy context that tangles reusable lessons with task-specific artifacts. We formulate online harness learning — a frozen agent improves by continually updating a structured harness across sequential tasks — and introduce **Evo-Harness**, whose core context-to-harness skill compilation distills noisy single-shot executions into reusable skill harnesses for cross-domain and topic-level adaptation. Evaluated across five realistic benchmarks (Terminal-Bench 2.0, SWE-bench, CL-Bench, τ-bench, WebArena-Infinity), Evo-Harness delivers consistent gains and, more importantly, isolates what actually drives on-the-fly self-improvement: feedback grounding, abstraction level, and solver–evolver alignment. Code is released at [A-Evolve](https://github.com/A-EVO-Lab/a-evolve/tree/release/evo-harness).   
...
- **5/30** **New EMNLP 2026** — [*Harness Updating Is Not Harness Benefit*](https://arxiv.org/abs/2605.30621) (arXiv 2605.30621). 7 evolver models × 6 solver agents × 3 benchmarks: counterintuitive answers on *who* produces good harness updates and *who* benefits. Code and algorithms are available at [A-Evolve](https://github.com/A-EVO-Lab/a-evolve/)
